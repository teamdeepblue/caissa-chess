class Piece < ActiveRecord::Base
  ...
  enum piece_name: [ :king_black, :king_white, :queen_black, :queen_white, 
  	:rook_black, :rook_white, :bishop_black, :bishop_white, :knight_black, :knight_white, :pawn_black, :pawn_white ]
