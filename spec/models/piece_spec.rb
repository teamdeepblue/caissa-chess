...
RSpec.describe Piece, type: :model do
  describe 'get_obstructing_pieces' do
    ...
    it 'should detect an obstructing piece vertically' do
      ...
      expect(piece.get_obstructing_pieces(0, 7)).to be true
    end
    ...
    it 'should detect an obstructing piece diagonally' do
      ...
      expect(piece.get_obstructing_pieces(7, 7)).to be true
    end
  end
end
